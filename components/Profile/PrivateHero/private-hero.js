        ...
        <>
            <div className="w-[100%] px-6 py-10 mb-10 bg-[#282B2E] rounded-[15px]">
                ...
                <div className="flex items-center my-8">
                    {form.avatar ? (<img className="w-[80px] object-cover h-[80px] bg-[#CFCEDC]  rounded-[50%] overflow-hidden" src={form.avatar} />) : (<div className="w-[80px] h-[80px] bg-[#CFCEDC] rounded-[50%] overflow-hidden"/>)}
                    <div className="mx-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className=" grid md:grid-cols-7">
                                                ...
                                                type="number" min="1900" max="2021" placeholder="Год"  className="md:col-span-2 my-2 md:my-0   rounded-[15px] bg-[#464951] pt-3 pb-3 pl-4 pr-4 text-white outline-none w-[95%]"/>
                        ...
                        <div className="grid md:grid-cols-2">
                            <div>
                                ...
                                <div className="mt-4">
                                    ...
                                    <select value={form.timezone} onChange={(e)=> setForm({...form,timezone:e.target.value})} name="timezone" id="1" className="col-span-2  rounded-[15px] bg-[#464951] pt-3 pb-3 pl-4 pr-4 text-white outline-none w-[95%]">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="mt-4">
                                                        ...
                                                        <Field name="nsdamsde" type="text"
                                                              value={form.web_site}
                                                              onChange={(e)=>setForm({...form,web_site:e.target.value})}
                                                              className="rounded-[15px] bg-[#464951] pt-3 pb-3 pl-4 pr-4 text-white outline-none w-[95%]"
